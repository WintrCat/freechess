...
export const startingPositionFen =
...
//FIXME: temporary functions to later replace when working
// on the globals
export function setBlackPlayer(player: Profile) {
    blackPlayer = player;
}
export function setWhitePlayer(player: Profile) {
    whitePlayer = player;
}
...
export async function drawBoard(fen: string) {
